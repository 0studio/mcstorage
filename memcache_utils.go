...
func GetClient(mcSetting string, maxActiveConnCnt int32, maxIdleConnCnt uint32, logError func(error), logInfo func(v ...interface{})) (mc memcache.Client) {
	mcAddrList := strings.Split(mcSetting, ",")
	if len(mcAddrList) == 1 {
		return getClientFromShardPool(mcAddrList, maxActiveConnCnt, maxIdleConnCnt, logError, logInfo)
...
func getClientFromShardPool(mcAddrList []string, maxActiveConnCnt int32, maxIdleConnCnt uint32, logError func(error), logInfo func(v ...interface{})) (mc memcache.Client) {
