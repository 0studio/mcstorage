...
func (this RedisListStorage) Get(key key.Key) (interface{}, error) {
...
func (this RedisListStorage) Set(key key.Key, object interface{}) error {
	cacheKey, err := BuildCacheKey(this.KeyPrefix, key)
	if err != nil {
		return err
	}
...
func (this RedisListStorage) MultiSet(valueMap map[key.Key]interface{}) error {
...
func (this RedisListStorage) AddItem(key key.Key, item interface{}) error {
	cacheKey, err := BuildCacheKey(this.KeyPrefix, key)
	if err != nil {
		return err
	}
...
func (this RedisListStorage) DeleteItem(key key.Key, item interface{}) error {
	cacheKey, err := BuildCacheKey(this.KeyPrefix, key)
	if err != nil {
		return err
	}
